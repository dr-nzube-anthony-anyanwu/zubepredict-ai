...
def _model_card(payload: dict[str, Any]) -> bytes:
    ...
    document = f"""<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>ZubePredict AI Model Card</title>
...
def generate_report_bundle(evidence: EvidenceEnvelope, result: Any) -> list[GeneratedReport]:
    ...
    reports = [
        ...
        _report(
            ...
            "zubepredict-reproducibility-manifest.json",
            "application/json",
